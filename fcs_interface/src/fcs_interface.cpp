...
bool FCS_Interface::start()
{
  ...
  prepare_service_ = node_handle_.advertiseService("fcs_interface/prepare_drone",  &FCS_Interface::getReady, this);
  ...
  home_service_ = node_handle_.advertiseService("fcs_interface/return_home",  &FCS_Interface::returnHome, this);
