...
ros::Publisher input_pub; //TODO(#1)
...
//max percentage level for the battery, technically dji_sdk should never return number bigger than 1 but it doesnt hurt to make this code safe																
constexpr int8_t kMaxBatteryLevel {100};
//min percentage level for the battery, technically dji_sdk should never return number smaller than 0 but it doesnt hurt to make this code safe																
